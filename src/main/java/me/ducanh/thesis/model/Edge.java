...
public class Edge extends AnchorPane implements Comparable<Edge>{
    ...
    private void dragBehaviour(){
        dfltDegree.bind(Bindings.createDoubleBinding(
                ()-> target.getCenterXProperty().get(),
                target.getCenterXProperty()
        ));
//        visEdgeLabel.setOnMouseDragged(drag->{
//            dfltDegree.set(cubicCurve.getTranslateX());
//        });
    }
